...
import 'package:humannode/ui/screens/home_screen.dart';
  ...
  static final router = GoRouter(
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          GoRoute(path: '/home', builder: (_, __) => const ChatScreen(), routes: [
            ...
            GoRoute(path: 'note/:noteId', builder: (_, state) => NoteEditorScreen(title: state.uri.queryParameters['title'] ?? '', content: state.uri.queryParameters['content'] ?? '')),
